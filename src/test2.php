...
if(isset($_POST) && isset($_POST["btnSubmit"]))
{
    ...
    /*==========================================================*/
    if( !empty($_POST['txtEmail']) && !empty($_POST['txtName']))
{   
    echo "SALUUUUUUUUUUUUUUUt";
    //Avoid XSS
    ...
    if($row > 0)
    {
        ...
        if(strlen($email))
        {
            ...
            if(strlen($name))
            {
                ...
                die();
            }else{header('Location: test2.php?login_err=password'); die(); }
        }else{ header('Location: test2.php?login_err=email'); die(); }
    }else{ header('Location: test2.php?login_err=already'); die(); }
